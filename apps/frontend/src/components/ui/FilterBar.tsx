  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        style={{ backgroundColor: "#1e293b", color: selected ? "white" : "#9ca3af" }}
      >
    ...
    <div className="w-full px-6 py-4" style={{ backgroundColor: "#0f172a" }}>
      ...
      <div className="flex gap-3 mb-4">
        <div className="flex flex-col gap-1 flex-1">
          <label className="text-gray-400 text-xs font-medium tracking-wide uppercase">Genre</label>
          <CustomSelect options={genreOptions} value={selectedGenre} placeholder="Tous les genres" onChange={handleGenreChange} />
        </div>

        <div className="flex flex-col gap-1 flex-1">
          <label className="text-gray-400 text-xs font-medium tracking-wide uppercase">Note minimale</label>
          <CustomSelect options={ratingOptions} value={selectedRating} placeholder="⭐ Toutes les notes" onChange={handleRatingChange} />
        </div>

        <div className="flex flex-col gap-1 flex-1">
          <label className="text-gray-400 text-xs font-medium tracking-wide uppercase">Année</label>
          <CustomSelect options={yearOptions} value={selectedYear} placeholder="📅 Toutes les années" onChange={handleYearChange} />
        </div>
      </div>
