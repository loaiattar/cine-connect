...
import { Clapperboard, Users, Loader2 } from "lucide-react";
import { usersService, type FollowUser } from "../service/users.service";
...
function ProfilePage() {
  ...
  const {
    ...
    queryFn: () => usersService.getFollowers(userIdNum),
    enabled: userIdNum > 0,
  });
  ...
  const {
    ...
    queryFn: () => usersService.getFollowing(userIdNum),
    enabled: userIdNum > 0,
  });
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <div className="mb-8 flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold">Profil #{userId}</h1>
        </div>
